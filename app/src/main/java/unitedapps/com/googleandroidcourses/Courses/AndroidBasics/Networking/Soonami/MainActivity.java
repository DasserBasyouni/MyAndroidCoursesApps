 ...
 */
package unitedapps.com.googleandroidcourses.Courses.AndroidBasics.Networking.Soonami;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ab_n_s_activity_main);
    ...
    private void updateUi(Event earthquake) {
        ...
        TextView titleTextView = findViewById(R.id.ab_n_s_title);
        titleTextView.setText(earthquake.title);

        // Display the earthquake date in the UI
        TextView dateTextView = findViewById(R.id.ab_n_s_date);
        dateTextView.setText(getDateString(earthquake.time));

        // Display whether or not there was a tsunami alert in the UI
        TextView tsunamiTextView = findViewById(R.id.ab_n_s_tsunami_alert);
    ...
    private String getTsunamiAlertString(int tsunamiAlert) {
        switch (tsunamiAlert) {
            case 0:
                return getString(R.string.ab_n_s_alert_no);
            case 1:
                return getString(R.string.ab_n_s_alert_yes);
            default:
                return getString(R.string.ab_n_s_alert_not_available);
        }
    }
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        protected Event doInBackground(URL... urls) {
            ...
            try {
                ...
                Log.e(LOG_TAG, "Problem putting Http the request in string", e);
            }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                int httpRespond = urlConnection.getResponseCode();
                if(httpRespond == HttpURLConnection.HTTP_OK){
                    inputStream = urlConnection.getInputStream();
                    jsonResponse = readFromStream(inputStream);
                }else {
                    Log.e(LOG_TAG, "Error response code: " + httpRespond);
                }
            } catch (IOException e) {
