...
public class ss8_DetailsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ss8_details_activity);
        if (savedInstanceState == null) {
            Bundle arguments = new Bundle();
            Log.i("Zx_", String.valueOf(getIntent().getData()));
            arguments.putString("uri", String.valueOf(getIntent().getData()));
            ss8_DetailFragment fragment = new ss8_DetailFragment();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.ss3_action_settings) {
            startActivity(new Intent(this, ss8_SettingsActivity.class));
            return true;
        }
