...
public class ss8_WindView extends View {
    ...
    public static final double ss8_MIN_VALUE = 0;
    public static final double ss8_MAX_VALUE = 100;
    ...
    public ss8_WindView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    {
        this.value = Math.min(ss8_MAX_VALUE, Math.max(ss8_MIN_VALUE, value));
    }
